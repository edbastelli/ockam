defmodule Ockam.API.Response.Tests do
  ...
  test "Encode/decode" do
    ...
    response = %Response{id: Response.gen_id(), request_id: Request.gen_id(), status: 200, body: "something"}
  ...
  test "To/from message" do
    ...
    response = %Response{id: Response.gen_id(), request_id: Request.gen_id(), status: 200, body: "something", to_route: ["onward", "route"]}
    ...
    assert Map.take(response_from, [:id, :request_id, :status, :body, :to_route]) == Map.take(response, [:id, :request_id, :status, :body, :to_route])
  end
