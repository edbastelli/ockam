defmodule Ockam.API.Request.Tests do
  ...
  test "To/from message" do
    ...
    request = %Request{id: Request.gen_id(), path: "my_path", method: :get, body: "something", to_route: ["onward", "route"]}
    ...
    assert Map.take(request_from, [:id, :path, :method, :body, :to_route]) == Map.take(request, [:id, :path, :method, :body, :to_route])
  end
