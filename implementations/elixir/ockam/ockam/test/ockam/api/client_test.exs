...
defmodule Ockam.API.Client.Tests do
  ...
  test "Request timeout" do
    {:error, :timeout} = Ockam.API.Client.sync_request(:get, "foo", "HI", ["non_existent_api"], 100)
  end
  ...
  test "Send request message" do
    ...
    body = "HELLO"
    {:ok, response} = Ockam.API.Client.sync_request(:get, "foo", body, ["echo_api"], 1000, self_address)
